      ...
      <div>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 b_packages">
          ...
          <div class="b_pack rows">
            ...
            <div class="col-md-4 col-sm-4 pack_icon pack_icon_2">
              <ul>
                <li>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 b_packages">
          ...
          <div class="b_pack rows">
            <div class="col-md-8 col-sm-8">
              <h4><a href="tour-details.html">Great Wall<span class="v_pl_name">(China)</span></a></h4> </div>
            <div class="col-md-4 col-sm-4 pack_icon pack_icon_2">
              <ul>
                <li>
                  <a href="#"><img src="images/clock.png" alt="Date" title="Tour Timing" /> </a>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 b_packages">
          ...
          <div class="b_pack rows">
            <div class="col-md-8 col-sm-8">
              <h4><a href="tour-details.html">Mauritius<span class="v_pl_name">(Mauritius Indiana)</span></a></h4> </div>
            <div class="col-md-4 col-sm-4 pack_icon pack_icon_2">
              <ul>
                <li>
                  <a href="#"><img src="images/clock.png" alt="Date" title="Tour Timing" /> </a>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12 b_packages">
          ...
          <div class="b_pack rows">
            <div class="col-md-8 col-sm-8">
              <h4><a href="tour-details.html">England<span class="v_pl_name">(England)</span></a></h4> </div>
            <div class="col-md-4 col-sm-4 pack_icon pack_icon_2">
              <ul>
                <li>
                  <a href="#"><img src="images/clock.png" alt="Date" title="Tour Timing" /> </a>
