      ...
      <div class="ed-mm-right">
        <div class="ed-mm-menu">
          ...
          <div class="ed-mm-inn">
            ...
            <h4><a href="all-package.html">Home</a></h4>
            <h4><a href="all-package.html">Holidays</a></h4>
            <h4><a href="all-package.html">Packages</a></h4>
            <ul>
              <li><a href="honeymoon-package.html">Couples Package</a></li>
              <li><a href="group-package.html">Family Package</a></li>
              <li><a href="weekend-package.html">Singles Package</a></li>
              <li><a href="regular-package.html">Boys Package</a></li>
              <li><a href="custom-package.html">Girls Package</a></li>
              <li><a href="custom-package.html">Friends Package</a></li>

            </ul>
            <h2><a href="all-package.html">About us</a></h2>
            <h4><a href="all-package.html">Contact us</a></h4>
            <!--<h4><a href="all-package.html">Profile</a></h4>-->
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12">
          ...
          <div class="main-menu">
            <ul>
              ...
              <li class="about-menu">
                <a href="/packages" class="mm-arr">Packages</a>
                <!-- MEGA MENU 1 -->
                <div class="mm-pos">
                  <div class="about-mm m-menu">
                    <div class="m-menu-inn">
                      ...
                      <div class="mm1-com mm1-s2">
                        <p>Want to change the world? At Berkeley we’re doing just that. When you join the Golden Bear community,global conversation every single day.</p>
                      </div>
                      <div class="mm1-com mm1-s3">
                        <ul>
                          <li><a href="booking-all.html">Couples Package</a></li>
                          <li><a href="booking-tour-package.html">Family Package</a></li>
                          <li><a href="booking-hotel.html">Singles Package</a></li>
                        </ul>
                      </div>
                      <div class="mm1-com mm1-s4">
                        <ul>
                          <li><a href="all-package.html">Boys Package</a></li>
                          <li><a href="family-package.html">Girls Package</a></li>
                          <li><a href="honeymoon-package.html">Friends Package</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
